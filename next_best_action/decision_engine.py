...
{{
    ...
    "reasoning": "Detailed explanation of why this channel/timing/message is optimal for maximizing resolution likelihood. Include specific factors from customer data that influenced your decision. Keep it really short and crisp should not exceed 2 sentences or 60 words"
}}
...
"""
    ...
    def _parse_gemini_response(self, response_text):
        ...
        try:
            ...
            required_fields = ['channel', 'send_time', 'message', 'reasoning']
    ...
    def _create_fallback_recommendation(self, customer_data):
        ...
        return {
            ...
            'reasoning': f"Fallback recommendation based on urgency ({urgency}) and sentiment ({sentiment}). Gemini AI analysis failed."
        }